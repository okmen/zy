...
public class DES {
	...
	/**
	 * 加密（过期，不可用） String明文输入,String密文输出
	 * 
	 * @param strMing
	 * 
	 * @return
	...
	/**
	 * 解密（过期，不可用） 以String密文输入,String明文输出
	 * 
	 * @param strMi
	 * 
	 * @return
	...
	/**
	 * （过期，不可用） 加密 以byte[]明文输入,byte[]密文输出
	 * 
	 *
	 * 
	 * @param byteS
	...
	public static void main(String[] args) {
		...
		//
		// Des des = new Des();// 实例化一个对�?
		//
		// des.getKey();// 生成密匙
		//
		// String strEnc = des.getEncString("云海飞舞�?122");//
		// 加密字符�?,返回String的密�?
		//
